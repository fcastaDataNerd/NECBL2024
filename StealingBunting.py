...
if page == "Stealing (Max)":
    ...
    if option == "Historical":
        ...
        if type=="2 Runs" and selected_player:
            ...
            max = B2.iloc[0]["Max"]
            min = B2.iloc[0]["Min"]
            tilt_minY = B2.iloc[1]['Tilt min']
            tilt_maxY = B2.iloc[1]['Tilt max']
            lean_minY = B2.iloc[1]['Lean min']
            lean_maxY = B2.iloc[1]['Lean max']
            likely_minY = B2.iloc[1]['Likely min']
            likely_maxY = B2.iloc[1]['Likely max']
            tilt_minN = B2.iloc[1]['Tilt min.1']
            tilt_maxN = B2.iloc[1]['Tilt max.1']
            lean_minN = B2.iloc[1]['Lean min.1']
            lean_maxN = B2.iloc[1]['Lean max.1']
            likely_minN = B2.iloc[1]['Likely min.1']
            likely_maxN = B2.iloc[1]['Likely max.1']
            if tilt_minY >= xruns >= tilt_maxY:
                recommendation = 'Tilt Bunt'
            elif lean_minY >= xruns >= lean_maxY:
                recommendation = 'Lean Bunt'
